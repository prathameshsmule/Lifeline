...
const Admin = () => {
  ...
  const fetchDonors = async () => {
    ...
    try {
      ...
      // Normalize keys (snake_case → camelCase fallback)
              ...
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    {camp.organizerName || camp.organizer_name || "N/A"}
                    <br />
                    <strong>Contact:</strong>{" "}
                    {camp.organizerContact || camp.organizer_contact || "N/A"}
                    <br />
                    <strong>PRO:</strong> {camp.proName || camp.pro_name || "N/A"}
                    <br />
                    <strong>Hospital:</strong>{" "}
                    {camp.hospitalName || camp.hospital_name || "N/A"}
                    <br />
